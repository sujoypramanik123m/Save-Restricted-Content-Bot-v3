    ...
    try:
        ...
        if os.path.exists(download_path):
            def edit_metadata():
                ...
                audio_file.tags["COMM"] = COMM(encoding=3, lang="eng", desc="Comment", text="Processed by Team @SuperToppers 🇮🇳")
...
def progress_callback(done, total, user_id):
    ...
    final = (
        ...
        f"╰──────────────────╯\n\n"
        f"**__Powered by Team @SuperToppers 🇮🇳__**"
    )
